...
class ParametersToShortLatentModelTrainer(ModelTrainer):
    def __init__(self, tensor_board=False, save_normalization_dict=True, tensor_board_files_suffix=""):
        super().__init__(ParametersToShortLatentModel, f"{TENSOR_BOARD_LOGS_DIR}_{tensor_board_files_suffix}", tensor_board)
